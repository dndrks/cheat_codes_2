  ...
  if get_grid_connected() then
    if params:string("grid_size") == "128" then
      ...
      if grid_page == 0 then
        ...
        for i = 1,3 do
          g:led(5+(5*(i-1)),7,pattern_gate[i][1].active == true and 8 or 0)
          g:led(5+(5*(i-1)),6,pattern_gate[i][2].active == true and 8 or 0)
        end
    ...
    elseif params:string("grid_size") == "64" then
      ...
      if grid_page_64 == 0 then
        ...
        g:led(2,8,pattern_gate[bank_64][1].active == true and 8 or 0)
        g:led(3,8,pattern_gate[bank_64][2].active == true and 8 or 0)
