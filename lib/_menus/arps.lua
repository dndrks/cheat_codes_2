  ...
  elseif n == 3 and z == 1 and not key2_hold and key1_hold then
    ...
    elseif _arps_.focus == "seq" then
      ...
      elseif _arps_.alt_view_sel == 2 then
        arps.cond_fill(_arps_.sel,arp[_arps_.sel].start_point,arp[_arps_.sel].end_point,arp[_arps_.sel].conditional.A[_arps_.seq_position[_arps_.sel]],arp[_arps_.sel].conditional.B[_arps_.seq_position[_arps_.sel]])
      end
    end
  end
  screen_dirty = true
